...
class AttentionWithRoPE(BaseModule):
    ...
    Args:
        ...
        proj_bias (bool): If True, add a learnable bias to output projection.
            Defaults to True.
        xattn (bool): If true, uses xFormer memory_efficient_attention to the attention layers
            Defaults to False.
...
class ViTEVA02WithXAttn(VisionTransformer):
    ...
    def __init__(self,
        ...
        kwargs.update(
            ...
            norm_cfg=norm_cfg,
            with_cls_token=with_cls_token)
        super(ViTEVA02WithXAttn, self).__init__(**kwargs)
