_base_ = [
    ...
    '_base_/datasets/test/synth2mapillary.py',
...
num_samples_per_gpu_test = 1    # because the preprocessor does not allow different image sizes in one batch at test time
