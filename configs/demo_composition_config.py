...
stride_size = (426,426)
num_classes = 19
iterations = 5000           # number of training loops
val_interval = 500          # interval (number of loops) for evaluation and checkpointing
batch_size = 16
...
model = dict(
    ...
    decode_head=dict(
        ...
        in_channels=[1024, 1024, 1024, 1024], # Why +19 in the third input?
        strides=[4, 8, 16, 32],
        feat_channels=256,
        out_channels=256,
...
# training schedule for [iterations]
